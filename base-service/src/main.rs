...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(|| {
        ...
        // BookingTicket
            .service(web::resource("api/book/_new").route(web::post().to(api::create::<BookingTicket>)))
            .service(web::resource("api/book/_get").route(web::post().to(api::get::<BookingTicket>)))
            .service(web::resource("api/book/_update").route(web::post().to(api::update::<BookingTicket>)))
            .service(web::resource("api/book/_search").route(web::post().to(api::search::<BookingTicket>)))
            .service(web::resource("api/book/_delete").route(web::post().to(api::delete::<BookingTicket>)))
            .service(web::resource("api/book/_relate").route(web::post().to(api::relate::<BookingTicket>)))
        // Authentication
            .service(web::resource("api/auth/_new").route(web::post().to(api::authentication::create_user)))
            .service(web::resource("api/auth/_get").route(web::post().to(api::authentication::get_user)))            
    }).bind(host_url)?
        .run()
        .await
}
